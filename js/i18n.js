  ...
  const TRANSLATIONS = {
    en: {
      ...
      host: {
        ...
        queryHint: 'Any valid Scryfall search query. See the syntax guide at scryfall.com/docs/syntax.',
    ...
    it: {
      ...
      host: {
        ...
        queryHint: 'Qualsiasi query di ricerca Scryfall valida. Consulta la guida alla sintassi su scryfall.com/docs/syntax.',
